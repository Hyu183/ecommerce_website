            ...
            <div className={classes.productContainer}>
              ...
              <div className={classes.thumbnail}>
                <img
                  src={
                    ...
                    product.productInfor.thumbnail_url
                  }
                  alt=""
                />
              </div>
              <div className={classes.productDetail}>
                <div>
                  ...
                  <div className={classes.productPrice}>
                    {"$" + product.productInfor.price.toFixed(2)}
                  </div>
                </div>
                <RatingReview
                  rating={4}
                ...
                <Color
                  ...
                  onColorSelectedChange={onColorSelectedChange}
                />
              ...
              <div className={classes.sameBrand}>
                <div className={classes.sameBrandText}>
                  <div className={classes.text}>More from</div>
                ...
                {sameBrandProduct.map((product) => {
                  return (
                    <Link to={`/product/${product.id}`} key={product.id}>
                      <img
                        src={
                          process.env.REACT_APP_API_URL + product.thumbnail_url
                        }
                        alt=""
                      />
                    </Link>
