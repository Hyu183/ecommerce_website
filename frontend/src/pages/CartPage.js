                    ...
                    <tr key={item.id} className={classes.row}>
                      <td>
                        <div className={classes.product}>
                          <img
                            src={
                              process.env.REACT_APP_API_URL + item.thumbnailUrl
                            }
                            alt=""
                          />
                          <div className={classes.wrapper}>
                            ...
                            <div className={classes.textButtonGroup}>
                              <span className={classes.buttonChange}>
                                Change
                              </span>
                              <span
                      ...
                      <td>
                        <div
                          ...
                          style={{
                            ...
                            opacity: item.color.opacity,
                          }}
                        ></div>
                      </td>
                      <td>
                        <div className={classes.size}>{item.size.name}</div>
                      </td>
                      <td>
                        <Quantity
                          ...
                          onQuantityChange={(unit) => {
                            cartCtx.changeQuantity(item.id, unit);
                          }}
                        />
                      </td>
                      <td>
          ...
          <div className={classes.checkout}>
            ...
            <div className={classes.bill}>
              ...
              <Row xs="auto" className="justify-content-between mt-2">
                ...
                <Col>{`$${cartCtx.totalPrice().toFixed(2)}`}</Col>
              </Row>
              ...
              <Row xs="auto" className="justify-content-between">
                ...
                <Col>
                  <strong>{`$${cartCtx.totalPrice().toFixed(2)}`}</strong>
                </Col>
              </Row>
            </div>
            {isCheckingOut ? (
