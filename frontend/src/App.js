    ...
    <React.Fragment>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/products/:catID" element={<ProductListPage />} />
          <Route path="/product/:proID" element={<ProductDetailPage />} />
          <Route
            path="/admin/*"
      ...
      {modalShowCtx.showLogIn && (
        <Modal onClose={modalShowCtx.hideLogInHandler}>
          <LoginForm
            ...
            navigateRegisterHandler={modalShowCtx.showRegisterHandler}
      ...
      {modalShowCtx.showRegister && (
        <Modal onClose={modalShowCtx.hideRegisterHandler}>
          <RegisterForm navigateLogInHandler={modalShowCtx.showLogInHandler} />
        </Modal>
      )}
