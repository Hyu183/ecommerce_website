...
import classes from './MutilselectInput.module.css';
import dropdownIcon from '../../../assets/dropdown.svg';
import closeIcon from '../../../assets/close-2.svg';

const MutilselectInput = (props) => {
    ...
    const MultiValueRemove = (props) => (
        <components.MultiValueRemove {...props}>
            <img src={closeIcon} alt='Remove' width='16px' height='16px' />
...
export default MutilselectInput;
